...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await sql`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS gateway VARCHAR(30);`;
    await sql`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS gateway_ref VARCHAR(255);`;
    ...
    await sql`
      CREATE TABLE IF NOT EXISTS virtual_cards (
        ...
        card_type VARCHAR(30) DEFAULT 'Virtual',
    ...
    res.status(200).json({ success: true, message: 'Tables créées avec succès (multi-gateway)' });
  } catch (error) {
